...
hide everything, all
select na, resn DT+U+DA+A+DG+G+DC+C+DG5+DG3+T+G+A+C+UFT+CFL
...
color white,back_b2
set cartoon_ring_color, gray60, resn DT+U+DT5+DT3+T+UFT
set cartoon_ring_color, gray30, resn DG+G+DG5+DG3
set cartoon_ring_color, gray20, resn DA+A+DA5+DA3
set cartoon_ring_color, gray70, resn DC+C+DC5+DC3+CFL
